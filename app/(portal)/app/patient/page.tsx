...
export default function PatientPortalPage() {
  ...
  const modules = [
    { title: t.dashboards.modules.consultations, Icon: MessageIcon },
    { title: t.dashboards.modules.prescriptions, Icon: PrescriptionIcon },
    { title: t.dashboards.modules.labResults, Icon: LabIcon },
    { title: t.dashboards.modules.messages, Icon: FileTextIcon },
  ];

  return (
    <div className="space-y-6">
      <PageHeader badge={<Badge tone="primary">{t.roles.patient}</Badge>} title={t.dashboards.patientTitle} description={t.dashboards.patientSubtitle} />
